        ...
        <div style={{ padding: 28, display: 'flex', flexDirection: 'column', gap: 14, maxWidth: 520 }}>
          ...
          <div style={{ background: PANEL, border: '1px solid ' + BORDER, borderRadius: 14, padding: 18 }}>
            ...
            <input
              ...
              style={{ width: '100%', boxSizing: 'border-box', background: '#141417', border: '1px solid ' + BORDER, borderRadius: 9, padding: '10px 12px', color: INK, fontSize: 14, outline: 'none', marginBottom: 10 }}
            />
